...
WebMCP (Web Model Context Protocol) — browser-native API for agent-ready websites, structured tool registration, declarative forms, and human-in-the-loop commerce
