...
description: >
  Implement the ACP Delegate Authentication API — delegating 3D Secure (3DS2)
  consumer authentication to merchant-specified providers, covering session
  creation, fingerprint and challenge actions, the authenticate call, and status
  handling. Use when adding strong customer authentication or 3DS to an ACP
  checkout.
---
