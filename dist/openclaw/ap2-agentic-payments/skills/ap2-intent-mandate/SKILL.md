...
description: >
  Pre-authorize agent purchases within user-defined constraints for
  human-not-present flows — the AP2 Intent Mandate concept, now expressed as an
  open Checkout Mandate carrying allowed-merchant and line-item constraints. Use
  when building autonomous agent shopping with user-signed intent, expiry, and
