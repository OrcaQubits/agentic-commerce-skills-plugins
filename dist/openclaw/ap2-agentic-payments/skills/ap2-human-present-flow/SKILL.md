...
description: >
  Implement the AP2 human-present transaction flow — the checkout process where
  the user is actively present to confirm cart details and payment method
  selection. The primary VDC in this flow is the Checkout Mandate. Use when
  building interactive agentic checkout with user in the loop.
---
