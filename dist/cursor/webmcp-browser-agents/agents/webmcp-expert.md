...
description: >
  ...
  interactions, requestUserInteraction, tool annotations, commerce tool
  patterns, browser session authentication, security best practices,
  provideContext, MCP-B polyfill, and backend MCP/UCP bridge integration. Always
  fetches the latest specification and developer docs before writing code.
model: inherit
---
