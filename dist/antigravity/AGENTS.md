...
Copy or symlink the plugin directories you need into your project. Your AI dev tool will automatically pick up the AGENTS.md files and the skills in `.agent/skills/`.
