...
name: bc-app-dev
description: >
  Build BigCommerce apps — single-click apps, OAuth flow, app callbacks,
  connector apps, control panel integration, and App Marketplace submission. Use
  when creating integrations that install via the BigCommerce App Marketplace.
---
