# ucp-agentic-commerce Rules

## ucp-expert

Universal Commerce Protocol (UCP) expert for building agentic commerce implementations. Use PROACTIVELY when the user is implementing UCP checkout flows, merchant servers, platform integrations, payment handlers, order management, discovery profiles, or any agentic commerce feature using UCP across REST, MCP, A2A, or Embedded bindings.
