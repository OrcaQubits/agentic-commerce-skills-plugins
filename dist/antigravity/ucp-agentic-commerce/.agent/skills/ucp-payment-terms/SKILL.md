...
description: >
  Implement the UCP Payment Terms extension (`dev.ucp.common.payment.terms`) —
  offering the buyer a choice of when payment is due via payment terms and
  schedules (pay now, deposit plus balance, deferred). Use when building
  split-timing payment options into a UCP checkout.
---
